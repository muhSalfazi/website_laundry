...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id_pelanggan'])) {
    ...
    $query = "UPDATE pelanggan SET nama_lengkap = '$nama_lengkap', no_telp = '$no_telp', alamat = '$alamat',edit_at = NOW() WHERE id_pelanggan = $id_pelanggan";

    if (mysqli_query($db_connect, $query)) {
        // Redirect ke halaman data pelanggan dengan pesan berhasil
        header('Location: ../admin/Pelanggan.php?berhasil=update_berhasil');
        exit();
    } else {
